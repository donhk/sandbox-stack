      ...
      {vmSnapshots.map((item, index) => (
        <CCard key={index} className="mb-4">
          <CCardHeader className="d-flex flex-wrap gap-3">
            ...
            <span>
              <strong>Home:</strong> {item.home}
            </span>
            <span>
              <strong>User:</strong> {item.vm_user}
            </span>
            <span>
              <strong>Pass:</strong> {item.vm_pass}
            </span>
          </CCardHeader>
          <CCardBody>
            <CTable align="middle" className="mb-0 border" hover responsive>
              <CTableHead className="text-nowrap">
                <CTableRow>
                  ...
                  <CTableHeaderCell>CPUs</CTableHeaderCell>
                  <CTableHeaderCell>RAM(MB)</CTableHeaderCell>
