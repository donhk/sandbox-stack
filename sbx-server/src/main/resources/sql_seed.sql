...
(prefix, machine_name, vm_user, vm_pass, home, snapshot_name, snapshot_cpus, snapshot_ram_mb, snapshot_comments)
VALUES ('windows', 'windows-vm', 'user1', 'password1', 'C:\users\user1', 'w1c1', 12, 12323, 'Special Snapshot Comments'),
       ('windows', 'windows-vm', 'user1', 'password1', 'C:\users\user1', 'w1c2', 6, 16000, 'Special Snapshot Comments'),

       ('linux1', 'linux-vm', 'user1', 'password1', '/home/user1', 'l1c1', 16, 18000, 'Special Snapshot Comments'),
       ('linux2', 'linux-vm', 'user1', 'password1', '/home/user1', 'l1c2', 8, 19000, 'Special Snapshot Comments3'),
       ('linux3', 'linux-vm', 'user1', 'password1', '/home/user1', 'l1c2', 8, 19000, 'Special Snapshot Comments2'),
       ('linux4', 'linux-vm', 'user1', 'password1', '/home/user1', 'l1c3', 9, 12000, 'Special Snapshot Comments1'),

       ('windows2', 'windows-vm2', 'user1', 'password1', 'C:\users\user1', 'w1c1', 12, 12323, 'Special Snapshot Comments'),
       ('windows2', 'windows-vm2', 'user1', 'password1', 'C:\users\user1', 'w1c2', 6, 16000, 'Special Snapshot Comments');
